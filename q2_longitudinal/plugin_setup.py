...
plugin.visualizers.register_function(
    ...
    description=(
        ...
        'identical samples receiving different treatments. This action tests '
        'whether the change in a numeric metadata value "metric" differs from '
        'zero and differs between groups (e.g., groups of subjects receiving '
        'different treatments), and produces boxplots of paired difference '
        'distributions for each group. Note that "metric" can be derived from '
        'a feature table or metadata.')
)
